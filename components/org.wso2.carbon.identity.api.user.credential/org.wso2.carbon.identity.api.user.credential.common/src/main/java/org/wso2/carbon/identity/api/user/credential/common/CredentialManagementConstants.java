...
public class CredentialManagementConstants {
    ...
    public enum CredentialTypes {
        ...
        PUSH_AUTH("push-auth", false),
        BACKUP_CODE("backup-code", true);

        private final String apiValue;
        private final boolean creatable;

        CredentialTypes(String apiValue, boolean creatable) {
        ...
        /**
         * Returns true for credential types that can be generated by an admin on behalf of a user
         * via the credential management API (e.g., backup-code).
         */
