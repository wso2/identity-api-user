...
public class BasicOrganizationObject  {
    ...
    /**
    **/
    public BasicOrganizationObject id(String id) {
    ...
    /**
    **/
    public BasicOrganizationObject name(String name) {
    ...
    public String toString() {
        ...
        sb.append("class BasicOrganizationObject {\n");
