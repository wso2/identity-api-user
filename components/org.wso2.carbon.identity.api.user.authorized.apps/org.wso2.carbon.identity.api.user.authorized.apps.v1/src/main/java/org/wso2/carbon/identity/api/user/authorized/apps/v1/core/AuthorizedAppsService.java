...
import org.wso2.carbon.identity.api.user.authorized.apps.v1.core.Constants.ErrorMessages;
import org.wso2.carbon.identity.api.user.authorized.apps.v1.core.functions.OAuthConsumerAppToExternal;
...
import static org.wso2.carbon.identity.api.user.authorized.apps.v1.core.Constants.ErrorMessages
        .ERROR_CODE_GET_APP_BY_ID_BY_USER;
import static org.wso2.carbon.identity.api.user.authorized.apps.v1.core.Constants.ErrorMessages
        .ERROR_CODE_GET_APP_BY_USER;
import static org.wso2.carbon.identity.api.user.authorized.apps.v1.core.Constants.ErrorMessages
        .ERROR_CODE_INVALID_APPLICATION_ID;
import static org.wso2.carbon.identity.api.user.authorized.apps.v1.core.Constants.ErrorMessages
        .ERROR_CODE_REVOKE_APP_BY_ID_BY_USER;
import static org.wso2.carbon.identity.api.user.authorized.apps.v1.core.Constants.ErrorMessages
        .ERROR_CODE_REVOKE_APP_BY_USER;
...
public class AuthorizedAppsService {
    ...
    public void deleteUserAuthorizedApps(User user) {
        ...
        try {
            ...
            throw handleError(Status.INTERNAL_SERVER_ERROR, ERROR_CODE_REVOKE_APP_BY_USER, user
    ...
    public void deleteUserAuthorizedApps(User user, String applicationId) {
        ...
        try {
            ...
            Optional<OAuthConsumerAppDTO> first = Arrays.stream(appsAuthorizedByUser)
                                                        ...
                                                        .findFirst();
            if (!first.isPresent()) {
                throw handleError(NOT_FOUND, ERROR_CODE_INVALID_APPLICATION_ID,
            ...
            throw handleError(Status.INTERNAL_SERVER_ERROR, ERROR_CODE_REVOKE_APP_BY_ID_BY_USER, applicationId, user
                    .toFullQualifiedUsername());
        } finally {
            PrivilegedCarbonContext.endTenantFlow();
        }
    ...
    public List<AuthorizedAppDTO> listUserAuthorizedApps(User user) {
        ...
        try {
            ...
            throw handleError(Status.INTERNAL_SERVER_ERROR, ERROR_CODE_GET_APP_BY_USER, user.toFullQualifiedUsername());
        } finally {
            PrivilegedCarbonContext.endTenantFlow();
        }
    ...
    public AuthorizedAppDTO listUserAuthorizedAppsByAppId(User user, String applicationId) {
        ...
        try {
            ...
            throw handleError(Status.INTERNAL_SERVER_ERROR, ERROR_CODE_GET_APP_BY_ID_BY_USER, applicationId, user
                    .toFullQualifiedUsername());
        } finally {
            PrivilegedCarbonContext.endTenantFlow();
        }
    ...
    private APIError handleError(Status status, ErrorMessages error, String... data) {
