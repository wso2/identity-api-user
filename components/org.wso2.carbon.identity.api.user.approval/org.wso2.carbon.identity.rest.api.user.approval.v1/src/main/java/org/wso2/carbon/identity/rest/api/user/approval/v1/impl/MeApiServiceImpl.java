...
public class MeApiServiceImpl extends MeApiService {
    ...
    public Response getApprovalTaskInfo(String taskId) {
        ...
        return Response.ok().entity(new UserApprovalService().getTaskData(taskId)).build();
    }

    @Override
    public Response listApprovalTasksForLoggedInUser(Integer limit, Integer offset, List<String> status) {

        return Response.ok().entity(new UserApprovalService().listTasks(limit, offset, status)).build();
    }
