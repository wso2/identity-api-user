...
public enum StateEnum {
    ...
    **/
    ...
    @ApiModelProperty(example = "john", value = "Username of the user who performed this authorization.")
    @JsonProperty("userId")
    @Valid
    ...
    **/
    public AuthorizationResponse state(StateEnum state) {
    ...
    **/
    public AuthorizationResponse updatedTime(Long updatedTime) {

        this.updatedTime = updatedTime;
        return this;
    }
    
    @ApiModelProperty(example = "1750156200000", value = "Milliseconds since epoch when this authorization was last updated.")
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.userId, authorizationResponse.userId) &&
            Objects.equals(this.state, authorizationResponse.state) &&
            Objects.equals(this.updatedTime, authorizationResponse.updatedTime);
    }
